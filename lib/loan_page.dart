...
//        ),
        ...
        bottomNavigationBar: new Theme(
          ...
          child: BottomNavigationBar(
              ...
              items: <BottomNavigationBarItem>[
                ...
                BottomNavigationBarItem(
                    icon: Icon(Icons.account_circle), title: Text('Loan')),
                BottomNavigationBarItem(
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Align(
                            ...
                            child: FloatingActionButton(
                              onPressed: () {
                                salaryEarnerPageController.animateToPage(1,
                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: TextField(
                            ...
                            onChanged: (value) => {clientEmploymentDate = value},
                          ),
                        ),
                        Padding(
                          padding: EdgeInsets.fromLTRB(0, 16, 0, 0),
                          child: TextField(
                            ...
                            onChanged: (value) => {clientNetMonthlySalary = value},
                          ),
                        ),
                            ...
                            child: Stack(
                              children: <Widget>[
                                Align(
                                  alignment: Alignment.bottomLeft,
                                  child: FloatingActionButton(
                                    onPressed: () => salaryEarnerPageController.animateToPage(0,
                                        duration: Duration(milliseconds: 400),
                                        curve: Curves.linear),
                                    tooltip: 'Next page',
                                    child: Icon(Icons.chevron_left),
                                ...
                                Align(
                                  alignment: Alignment.bottomRight,
                                  child: FloatingActionButton(
                                    onPressed: () => salaryEarnerPageController.animateToPage(2,
                                        duration: Duration(milliseconds: 400),
                                        curve: Curves.linear),
                                    tooltip: 'Next page',
                                    child: Icon(Icons.chevron_right),
                            ...
                            child: Stack(
                              children: <Widget>[
                                Align(
                                  alignment: Alignment.bottomLeft,
                                  child: FloatingActionButton(
                                    onPressed: () => salaryEarnerPageController.animateToPage(1,
                                        duration: Duration(milliseconds: 400),
                                        curve: Curves.linear),
                                    tooltip: 'Previous page',
                                    child: Icon(Icons.chevron_left),
                                ...
                                Align(
                                  alignment: Alignment.bottomRight,
                                  child: FloatingActionButton(
                                    onPressed: () => salaryEarnerPageController.animateToPage(3,
                                        duration: Duration(milliseconds: 400),
                                        curve: Curves.linear),
                                    tooltip: 'Next page',
                                    child: Icon(Icons.chevron_right),
                            ...
                            child: Stack(
                              children: <Widget>[
                                ...
                                Align(
                                  alignment: Alignment.bottomRight,
                                  child: FloatingActionButton(
                                    onPressed: () => salaryEarnerPageController.animateToPage(5,
                                        duration: Duration(milliseconds: 400),
                                        curve: Curves.linear),
                                    tooltip: 'Next page',
                                    child: Icon(Icons.chevron_right),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: <Widget>[
          ...
          Padding(
              padding: EdgeInsets.all(16),
              child: Center(child: Text(currentUserEmail))),
          Padding(
              padding: EdgeInsets.all(16),
              child: Center(child: Text(currentUserPhone))),
          SizedBox(
              width: double.infinity,
              height: 60.0,
              child: Padding(
  ...
  //The Personal details form
  Widget getResidentialDetailsForm(){
    return SingleChildScrollView(
        child: Container(
          padding: EdgeInsets.all(24.0),
          child: (Column(
            verticalDirection: VerticalDirection.down,
            children: <Widget>[
              Text("Client Residential Details", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  onChanged: (value) => {clientAnnualRent = value},
                ),
              ),
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  onChanged: (value) => {clientMonthlyTurnover = value},
                ),
              ),
